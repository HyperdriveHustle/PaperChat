...
class Paper:
    ...
    def _get_all_page_index(self):
        ...
        section_list = ["Abstract",
                        'Introduction', 'Related Work', 'Related work', 'Background',
                        'Why Generalization Occurs: Representations and Dynamics',
                        'Delayed Generalization: A Phase Diagram',
                        "Preliminary", "Problem Formulation",  "Problem Setting",
